  ...
  networks: {
    hardhat: {
      ...
      accounts: [
        ...
        { balance: "1000000000000000000", privateKey: process.env.PRIV_KEY },
        {
          ...
          //@ts-ignore
          privateKey: process.env.OTHER_PRIV_KEY,
        },
      ],
    },
    ...
    rinkeby: {
      ...
      url:
        ...
        "https://rinkeby.infura.io/v3/fee5821234524325b482f04d51c75878",
    ...
    owl: {
      ...
      url:
        process.env.OWL_URL ||
        "https://blockchain.istio.owlprotocol.xyz/poa/rpc",
      //@ts-ignore will not be undefined
      accounts: [process.env.PRIV_KEY, process.env.OTHER_PRIV_KEY],
    },
  },
